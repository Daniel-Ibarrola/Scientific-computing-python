...
class UnitTests(unittest.TestCase):
    ...
    def test_too_many_problems(self):
        self.assertRaises(Exception, arithmetic_arranger, ["44 + 815", "909 - 2", "45 + 43", "123 + 49", "888 + 40", "653 + 87"])
        
    def test_incorrect_operator(self):
        self.assertRaises(Exception, arithmetic_arranger, ["3 / 855", "3801 - 2", "45 + 43", "123 + 49"])
        
    def test_too_many_digits(self):
        self.assertRaises(Exception, arithmetic_arranger,["24 + 85215", "3801 - 2", "45 + 43", "123 + 49"])

    def test_only_digits(self):
        self.assertRaises(Exception, arithmetic_arranger, ["98 + 3g5", "3801 - 2", "45 + 43", "123 + 49"])
